...
-- Força o banco a desconectar todos os usuários e permite DROP
IF DB_ID('SistemaFuncionariosDB') IS NOT NULL
BEGIN
    ALTER DATABASE SistemaFuncionariosDB SET SINGLE_USER WITH ROLLBACK IMMEDIATE;
