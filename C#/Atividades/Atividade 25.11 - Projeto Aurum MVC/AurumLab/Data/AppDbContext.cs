...
public partial class AppDbContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.IdDispositivo).HasName("PK__Disposit__B1EDB8E4B9CC3EC5");
        ...
        {
            entity.HasKey(e => e.IdLocal).HasName("PK__LocalDis__C287B9BBB79854E1");
        ...
        {
            entity.HasKey(e => e.IdManutencao).HasName("PK__Manutenc__CD0C6B2AC95C3508");
        ...
        {
            entity.HasKey(e => e.IdRegra).HasName("PK__RegraPer__E4F2CC24D9921AFE");

            entity.ToTable("RegraPerfil");

            entity.HasIndex(e => e.Nome, "UQ__RegraPer__7D8FE3B2D11118DE").IsUnique();
        ...
        {
            entity.HasKey(e => e.IdTipoDispositivo).HasName("PK__TipoDisp__A9EEE648B96F1ED6");
        ...
        {
            entity.HasKey(e => e.IdTipoManutencao).HasName("PK__TipoManu__BE62BE4EFDBDD5A3");
        ...
        {
            entity.HasKey(e => e.IdUsuario).HasName("PK__Usuario__5B65BF9724FBB7AB");

            entity.ToTable("Usuario");

            entity.HasIndex(e => e.Email, "UQ__Usuario__A9D10534F25A8789").IsUnique();
